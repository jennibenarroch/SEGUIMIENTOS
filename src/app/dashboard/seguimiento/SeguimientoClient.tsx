...
import {
  ...
  Presentation, Printer, MessageSquare, Mail, MessageCircle, Send, Copy,
  Phone, TrendingUp, Zap,
} from "lucide-react";
...
// ── Modal de estrategias de venta ─────────────────────────────────────────────

function DealStrategiesModal({
  deal,
  onClose,
  onUseStrategy,
}: {
                    ...
                    <div className="p-4 space-y-3">
                      ...
                      <div className="flex gap-2 pt-1 flex-wrap">
                        {isCanalSendable ? (
                          <button
                            onClick={() => {
                              onUseStrategy(s, s.canal as "email" | "whatsapp");
                              onClose();
                            }}
...
// ── Modal de seguimiento (email / WhatsApp) ──────────────────────────────────
            ...
            <div className="space-y-4">
              ...
              {channel === "email" && emailTo && (
                <p className="text-xs text-slate-500">
                  ...
                  <span className="ml-2 text-slate-600">· CC: jenni.benarroch@sicobenediciones.com</span>
                </p>
              )}
              {channel === "email" && !emailTo && (
